                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">SWS Philosophy Transcript Database</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM transcriptYear4";
                                            ...
                                            if(mysqli_num_rows($result) > 0){
                                                ...
                                                while($row = mysqli_fetch_array($result)){
                                                    echo "<tr>";
                                                        ...
                                                        echo "<td>" . $row['finaltotalGP'] . "</td>";
                                                        echo "<td>" . $row['finaltotalCGPA'] . "</td>";
                                                        echo "<td>" . $row['_classification'] . "</td>";
                                                        echo "<td>" . $row['created_at'] . "</td>";
                                                        echo "<td>";
                                                            echo "<a href='download.php?id=". $row['id'] ."' title='Download' data-toggle='tooltip' style='padding-right:5px;' ><span><i class='fa fa-download' aria-hidden='true'></i></span></a>";
                                                            echo "<a href='view.php?id=". $row['id'] ."' title='View' data-toggle='tooltip' style='padding-right:5px;'><span><i class='fa fa-eye' aria-hidden='true'></i></span></a>";
                                                            echo "<a href='delete-authorization.php?id=". $row['id'] ."' title='Delete' data-toggle='tooltip'><span><i class='fa fa-trash' aria-hidden='true'></i></span></a>";
                                                        echo "</td>";
                                                    echo "</tr>";
                                                }
                                                echo "</tbody>";                            
