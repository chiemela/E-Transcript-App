                            ...
                            <div class="card shadow mb-4">
                                ...
                                <form>
                                    ...
                                    <div class="row">
                                        ...
                                        <label ><strong>First Name:</strong> Philosophy</label>
                                        </div>
                                        <div class="form-group col-md-12">
                                        <label ><strong>Last Name:</strong> SWS</label>
                                        </div>
                                        <div class="form-group col-md-12">
                                        <label ><strong>Email:</strong> hodphilsws@gmail.com</label>
                                        </div>
                                        <div class="form-group col-md-12">
                                        <label ><strong>Address:</strong> Seat of Wisdom Seminary Ulakwo, Imo, Nigeria.</label>
                                        </div>
                                        <div class="form-group col-md-12">
                                        <label ><strong>Contact Personnel:</strong> Rev. Ifeanyi Onyekwere</label>
                                        </div>
                                    </div>
