            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Save As PDF</h1>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="row">
                                    <div class="text-center form-group col">
                                        <label ><strong><?php echo $_SESSION["studentName"];?></strong></label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="text-center form-group col">
                                        <button class="col-md-2 justify-content-center btn btn-primary"><i
                                ...
                                class="fas fa-save fa-sm text-white-50"></i>&nbsp;&nbsp;Generate</button>
                                    </div>
                                    <div class="row">
