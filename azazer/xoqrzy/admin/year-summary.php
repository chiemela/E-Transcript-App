...
// Check if the user is logged in, if not then redirect him to page
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // Get the total CGPA
    $totalCGPA = $_SESSION['SEMESTER_GPA_FOURTH_YEAR_SEMSTER_1'] + $_SESSION['SEMESTER_GPA_FOURTH_YEAR_SEMSTER_2'] + $_SESSION['SEMESTER_GPA_FOURTH_YEAR_SEMSTER_1'] + $_SESSION['SEMESTER_GPA_FOURTH_YEAR_SEMSTER_2'] + $_SESSION['SEMESTER_GPA_FOURTH_YEAR_SEMSTER_1'] + $_SESSION['SEMESTER_GPA_FOURTH_YEAR_SEMSTER_2'] + $_SESSION['SEMESTER_GPA_FOURTH_YEAR_SEMSTER_1'] + $_SESSION['SEMESTER_GPA_FOURTH_YEAR_SEMSTER_2'];
