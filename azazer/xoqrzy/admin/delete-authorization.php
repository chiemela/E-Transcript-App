                            ...
                            <p></p>
                                ...
                                <div class="row">
                                    <div class="text-center form-group col">
                                        ...
                                        <label style="color:red;"><strong>YOU ARE ABOUT TO PERMANENTLY DELETE THIS RECORD</strong></label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="text-center form-group col">
                                        <label ><strong></br>Student Name: <?php echo $_SESSION["studentName"];?></strong></label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="text-center form-group col">
                                        <label ><strong>Mat_NO: <?php echo $_SESSION["matricNumber"];?></strong></label>
                                    </div>
                                </div>
                                
                                <div class="card-body">
                                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                    <div class="form-row"><div class="col-md-6"></div>
                                        <a href="manage.php" class="col-md-2 justify-content-center btn btn-secondary"><i
                                    class=" fa-sm text-white-50"></i>Cancel</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="submit" class="col-md-2 justify-content-center btn btn-primary"><i
                                class="fa fa-trash fa-sm text-white-50"></i>&nbsp;&nbsp;Yes! Delete</button>
                                    </div>
                                <p></p>
                                <p></p>
                                <p></p>
